...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConsoleApp7.Airplane", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleApp7.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ConsoleApp7.Flight", b =>
                {
            ...
            modelBuilder.Entity("ClientFlight", b =>
                {
                    b.HasOne("ConsoleApp7.Client", null)
                        .WithMany()
                        .HasForeignKey("ClientsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ConsoleApp7.Flight", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ConsoleApp7.Flight", b =>
                {
                    b.HasOne("ConsoleApp7.Airplane", "Airplane")
                        .WithMany("Flights")
